    ...
    "value": .assets
        | map(select(
            ...
            (
                ...
                ( (.name | contains("windows") | not) and (.name | contains("gnu") ) and (.name | contains("gnueabihf") | not) and (.name | contains("aarch64") ) ) or
                ( (.name | contains("windows") | not) and (.name | contains("musl") ) and (.name | contains("x86_64") ) ) or
